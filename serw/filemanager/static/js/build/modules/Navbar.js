...
export default class Navbar {
    ...
    createNavbar() {
        ...
        this.hoverElement.style.top = `${this.navbarListItems[this.currentIcon].offsetTop - 4}px`;
        this.hoverElement.style.height = `${this.navbarListItems[this.currentIcon].offsetHeight}px`;
